...
export const faqSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { question: "What do the popcorn rating labels mean?", answer: "The labels describe the numeric PopScore: Extra Buttery is 90–100, Buttery is 75–89, Fresh is 60–74, Salty is 40–59, and Burnt is 0–39. They are labels for the same score, not separate votes." },
