...
const expectedTokenHash = "0942a1ea48908ae42d64ce7d95045a003ed977e86f6b784da03dabaf7e8dc0be";
...
export async function POST(request: Request) {
  ...
  const html = preview.html.replace(
    '<span style="display:none!important;',
    `${sampleBanner}<span style="display:none!important;`
  );
  const response = await fetch("https://api.resend.com/emails", {
    ...
    headers: {
      ...
      "Idempotency-Key": "monthly-watchlist-design-preview-compact-2026-09-05",
    },
    body: JSON.stringify({
      from,
      html,
